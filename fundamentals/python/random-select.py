...
"""
selected_list = random.choices(element_list, cum_weights=cum_weights_list, k=1)
...
"""
counts = [1, 2, 2, 4, 5, 5]
selected_list = random.sample(element_list, k=1)
...
# how to test with the same set of random generated numbers every time.
random.seed(42)
